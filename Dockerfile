...
#high-availability
RUN curl -fSsL \
    ${GERRITFORGE_URL}/job/plugin-high-availability-bazel-master-stable-${PLUGIN_VERSION}/${GERRITFORGE_ARTIFACT_DIR}/high-availability/high-availability.jar \
